...
const DEFAULT_DESCRIPTION =
  "Vérifiez l'authenticité de vos sneakers, sacs et vêtements de luxe en 47 secondes (durée médiane). Score de confiance par IA Vision, analyse de 8 zones d'authentification. 3,99 €/scan.";
