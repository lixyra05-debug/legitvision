      ...
      <RevealGroup className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {pages.map((page) => (
          <RevealItem key={page.href}>
            <Link
              href={page.href}
              className="group block h-full rounded-lg border border-line-subtle bg-surface p-4 transition-colors duration-fast hover:border-line hover:bg-surface-hover"
            >
