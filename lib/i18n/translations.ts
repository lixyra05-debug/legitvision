...
// Chiffres affichés : jamais écrits ici, toujours lus dans lib/site-facts.ts.
const FACTS = facts();
...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      subtitle:
        `Prenez quelques photos, notre IA analyse chaque détail et vous donne un score de confiance en ${FACTS.median} secondes (durée médiane). Sneakers, sacs, vêtements.`,
    ...
    landing: {
      ...
      step2Desc:
        `Notre modèle de vision examine chaque détail de vos photos. Notre base compte ${FACTS.authPoints} points d'authentification, répartis sur les modèles couverts.`,
      ...
      feature1Desc:
        `Selon le modèle, notre modèle de vision artificielle examine jusqu'à ${FACTS.maxZones} zones d'authentification : coutures, matériaux, logos, étiquettes, quincaillerie, alignement, typographie, finitions…`,
      feature1Tag: `Jusqu'à ${FACTS.maxZones} zones`,
      feature2Title: `Résultat en ${FACTS.median} secondes`,
      feature2Desc:
        `Pas besoin d'attendre des heures : entre le lancement de l'analyse et le rapport complet, il faut en médiane ${FACTS.median} secondes, envoi des photos compris.`,
      feature2Tag: `Médiane mesurée : ${FACTS.median} s`,
      ...
      ctaFinalSubtitle: `Résultat en ${FACTS.median} secondes (durée médiane). Sneakers, sacs, vêtements.`,
      ctaFinalButton: "Commencer maintenant",
      ctaFinalNote: `Première analyse à ${FACTS.priceSingle} · Sans abonnement`,
      smallCtaTitle: "Vérifiez votre prochain article",
      smallCtaButton: "Analyser un article",
      smallCtaNote: `Première analyse à ${FACTS.priceSingle} · Sans abonnement`,
      ...
      brandsCategoriesCount: `${FACTS.brands} marques et ${FACTS.models} modèles analysables`,
      ...
      videoSubtitle: "Comprendre en un coup d'œil comment l'IA analyse vos articles.",
    },
    plans: {
      single: {
        name: "Utilisation unique",
        price: FACTS.priceSingle,
        period: "/ analyse",
        ...
        feature3: `Résultat en ${FACTS.median} s (médiane)`,
      ...
      pro: {
        ...
        credits: `${FACTS.proAnalyses} analyses / mois`,
        feature1: "Toutes catégories",
        feature2: "Recommandations en cas de doute",
      ...
      premium: {
        name: "Premium",
        price: FACTS.priceBusiness,
        period: "/mois",
        description: "Pour les revendeurs et pros",
        credits: `${FACTS.businessAnalyses} analyses / mois`,
        feature1: "Toutes catégories",
        feature2: "Recommandations en cas de doute",
        feature3: "Support par e-mail",
        feature4: "Historique illimité",
        feature5: "",
        cta: "Choisir ce forfait",
    ...
    pricing: {
      ...
      pro: "Pro",
      proDesc: `${FACTS.proAnalyses} analyses par mois`,
      premium: "Premium",
      premiumDesc: `${FACTS.businessAnalyses} analyses par mois`,
      cta: "Commencer",
    ...
    subscription: {
      ...
      noActiveDesc:
        "Souscrivez à un plan pour analyser vos articles chaque mois.",
      ...
      planFree: "Gratuit",
      planPro: `Pro — ${FACTS.pricePro}/mois`,
      planBusiness: `Business — ${FACTS.priceBusiness}/mois`,
    },
    planBanner: {
      businessName: "Plan Business",
      businessDesc: `${FACTS.businessAnalyses} analyses par mois`,
      active: "Actif",
      proName: "Plan Pro",
      ...
      proCta: `Pro — ${FACTS.pricePro}/mois`,
    ...
    paywall: {
      ...
      subtitle:
        "Vous devez disposer d'un crédit pour lancer une analyse. Choisissez une formule ci-dessous.",
      single: "Analyse unique",
      tenAnalyses: `${FACTS.proAnalyses} analyses`,
      fiftyAnalyses: `${FACTS.businessAnalyses} analyses`,
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        `Take a few photos, our AI analyzes every detail and gives you a confidence score in ${FACTS_EN.median} seconds (median). Sneakers, bags, clothing.`,
      cta: "Check now",
    ...
    landing: {
      ...
      step2Desc:
        `Our vision model examines every detail of your photos. Our database holds ${FACTS_EN.authPoints} authentication points across the models we cover.`,
      ...
      feature1Desc:
        `Depending on the model, our computer vision model examines up to ${FACTS_EN.maxZones} authentication zones: stitching, materials, logos, labels, hardware, alignment, typography, finishes…`,
      feature1Tag: `Up to ${FACTS_EN.maxZones} zones`,
      feature2Title: `Results in ${FACTS_EN.median} seconds`,
      feature2Desc:
        `No need to wait hours: from launching the analysis to the full report takes a median of ${FACTS_EN.median} seconds, photo upload included.`,
      feature2Tag: `Measured median: ${FACTS_EN.median} s`,
      ...
      ctaFinalSubtitle: `Results in ${FACTS_EN.median} seconds (median). Sneakers, bags, clothing.`,
      ctaFinalButton: "Get started",
      ctaFinalNote: `First analysis at ${FACTS_EN.priceSingle} · No subscription`,
      smallCtaTitle: "Verify your next item",
      smallCtaButton: "Analyze an item",
      smallCtaNote: `First analysis at ${FACTS_EN.priceSingle} · No subscription`,
      brandsCategoriesTitle: "Brands and categories",
      brandsCategoriesSubtitle:
        "Brand-specific authentication protocols",
      brandsCategoriesCount: `${FACTS_EN.brands} brands and ${FACTS_EN.models} models supported`,
      ...
      videoSubtitle: "See at a glance how AI analyzes your items.",
    },
    plans: {
      single: {
        name: "Single use",
        price: FACTS_EN.priceSingle,
        period: "/ analysis",
        description: "For a one-off check",
        credits: "1 full analysis",
        feature1: "All categories",
        feature2: "Detailed report",
        feature3: `Result in ${FACTS_EN.median} s (median)`,
        cta: "Analyze now",
        badge: "",
      },
      pro: {
        ...
        credits: `${FACTS_EN.proAnalyses} analyses / month`,
        feature1: "All categories",
        feature2: "Recommendations when in doubt",
      ...
      premium: {
        name: "Premium",
        price: FACTS_EN.priceBusiness,
        period: "/month",
        description: "For resellers and pros",
        credits: `${FACTS_EN.businessAnalyses} analyses / month`,
        feature1: "All categories",
        feature2: "Recommendations when in doubt",
        feature3: "Email support",
    ...
    pricing: {
      ...
      pro: "Pro",
      proDesc: `${FACTS_EN.proAnalyses} analyses per month`,
      premium: "Premium",
      premiumDesc: `${FACTS_EN.businessAnalyses} analyses per month`,
      cta: "Get started",
    ...
    subscription: {
      ...
      noActiveDesc:
        "Subscribe to a plan to analyze your items every month.",
      ...
      needHelp: "Need help?",
      planFree: "Free",
      planPro: `Pro — ${FACTS_EN.pricePro}/month`,
      planBusiness: `Business — ${FACTS_EN.priceBusiness}/month`,
    },
    planBanner: {
      businessName: "Business plan",
      businessDesc: `${FACTS_EN.businessAnalyses} analyses per month`,
      active: "Active",
      proName: "Pro plan",
      ...
      proCta: `Pro — ${FACTS_EN.pricePro}/month`,
      businessCta: "Business",
    },
    successBanner: {
    ...
    paywall: {
      ...
      single: "Single analysis",
      tenAnalyses: `${FACTS_EN.proAnalyses} analyses`,
      fiftyAnalyses: `${FACTS_EN.businessAnalyses} analyses`,
