...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      subtitle:
        "Prenez quelques photos, notre IA analyse chaque détail et vous donne un score de confiance en 47 secondes (durée médiane). Sneakers, sacs, vêtements.",
      cta: "Vérifier maintenant",
      ctaSecondary: "Voir les marques",
      analyzeItem: "Analyser un article",
      tagFastResult: "Résultat : 47 s (médiane)",
      tagGdpr: "RGPD",
      tagEu: "Hébergé EU",
    },
    landing: {
      ...
      feature2Tag: "Médiane mesurée : 47 s",
      ...
      ctaFinalSubtitle: "Résultat en 47 secondes (durée médiane). Sneakers, sacs, vêtements.",
    ...
    plans: {
      single: {
        ...
        feature3: "Résultat en 47 s (médiane)",
    ...
    results: {
      ...
      analyzingDesc:
        "Une analyse dure 47 secondes en médiane. Actualisez la page dans un instant pour afficher le rapport.",
    },
    dashboard: {
      greeting: "Bonjour",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Take a few photos, our AI analyzes every detail and gives you a confidence score in 47 seconds (median). Sneakers, bags, clothing.",
      cta: "Check now",
      ctaSecondary: "View brands",
      analyzeItem: "Analyze an item",
      tagFastResult: "Result: 47 s (median)",
      tagGdpr: "GDPR",
      tagEu: "EU hosted",
    },
    landing: {
      ...
      feature2Tag: "Measured median: 47 s",
      ...
      ctaFinalSubtitle: "Results in 47 seconds (median). Sneakers, bags, clothing.",
    ...
    plans: {
      single: {
        ...
        feature3: "Result in 47 s (median)",
        cta: "Analyze now",
        badge: "",
      },
      pro: {
    ...
    results: {
      ...
      analyzingDesc:
        "An analysis takes a median of 47 seconds. Refresh the page in a moment to see your report.",
    },
    dashboard: {
      greeting: "Hello",
