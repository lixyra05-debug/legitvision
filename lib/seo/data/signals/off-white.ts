    ...
    faqs: [
      {
        ...
        answer:
          "Oui, dans deux cas. Premier cas : la pièce a été achetée et le zip tie coupé puis jeté par le premier propriétaire. L'authentification bascule alors sur étiquette col, impression arrows, tag main label, coutures. Deuxième cas : certaines pièces techniques (GORE-TEX, vestes performance) ne sont pas livrées avec zip tie — c'est documenté sur off---white.com et cohérent. En revanche, un tee ou un hoodie Off-White vendu « neuf avec tags » sans zip tie est suspect : il aurait dû être présent à la livraison.",
      },
      {
        question:
  ...
  },
  {
    ...
    commonErrors: [
      ...
      },
      {
        ...
        description:
          "Les fakes bas de gamme impriment les 4 flèches dans la même orientation (par flemme de gabarit). Sur une pièce d'origine, c'est toujours une croix.",
      },
      {
