  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Elle rend l'authentification plus difficile mais ne tranche pas. Si le numéro embossé sur cuir et sur sticker correspond, le sac peut rester authentique malgré la carte manquante. Chanel ne remplace PAS les cartes perdues (politique officielle). La valeur revente diminue sans carte, mais le sac reste commercialisable. En revanche, une carte RETROUVÉE avec un numéro différent du cuir est très suspecte — carte récupérée d'un autre sac.",
      },
    ],
  },
  {
