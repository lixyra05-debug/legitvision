...
export const louisVuittonSignals: GuideSignal[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Chaque modèle LV a une date de lancement : Neverfull = 2007, Pochette Métis = 2012, Capucines = 2013, Twist = 2014. Un date code antérieur à la date de lancement du modèle est un signal fort de contrefaçon.",
      },
    ],
    commonErrors: [
      {
