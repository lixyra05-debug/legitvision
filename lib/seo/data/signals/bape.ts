...
export const bapeSignals: GuideSignal[] = [
  ...
  },
  {
    ...
    intro:
      "Le WGM — « World Gone Mad » — est l'acronyme brodé au dos du Shark Hoodie BAPE, la pièce la plus iconique de la marque depuis 2005. Les trois lettres en majuscules forment un trident visuel positionné entre les omoplates, et leur réalisation technique est un signal d'authentification majeur. Sur un Shark Hoodie d'origine, le WGM mesure 25×8 cm (tolérance ± 5 mm), est brodé en fil de coton mercerisé avec 1 800 à 2 200 points, utilise la police BAPE Custom Sans Serif (une variante exclusive dérivée de la Futura Bold), et la couleur du fil varie selon la version : blanc pour Shark Hoodie noir ou marine, noir pour Shark Hoodie blanc ou beige, rouge pour Shark Hoodie camo rouge, jaune pour camo jaune. Le positionnement est précis : le centre du W se trouve à 18 cm sous la couture du col, et l'axe vertical du motif est strictement aligné avec l'axe vertical du dos (test à la règle). Chaque lettre mesure 7×8 cm exactement (tolérance ± 2 mm). Les contrefaçons trahissent plusieurs défauts : dimensions incorrectes (30×10 cm trop grand, 20×6 cm trop petit), positionnement désaxé par rapport au centre du dos (décalage latéral de 1-2 cm visible), broderie lacunaire laissant apparaître le textile, fil synthétique polyester brillant au lieu de coton mat, ou — détail typique — lettres de dimensions inégales entre elles (W plus grand que M, etc.).",
    steps: [
      {
    ...
    commonErrors: [
      {
        ...
        description:
          "Une pièce BAPE deadstock avec tags vaut plus cher en revente qu'une pièce sans. Photographiez-les, vérifiez-les, puis coupez — mais conservez-les dans le sac d'origine.",
      },
      {
