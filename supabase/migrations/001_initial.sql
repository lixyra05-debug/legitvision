...
insert into public.brands (name, slug, category, photo_protocol) values
  ('Nike', 'nike', 'sneakers', '[
    {"type": "overall_front", "label": "Vue de face", "required": true},
    {"type": "overall_back", "label": "Vue arrière", "required": true},
    {"type": "sole_bottom", "label": "Semelle (dessous)", "required": true},
    {"type": "sole_side", "label": "Semelle (côté)", "required": true},
    {"type": "tag_label", "label": "Étiquette intérieure", "required": true},
    {"type": "tag_size", "label": "Étiquette taille", "required": true},
    {"type": "box_label", "label": "Étiquette boîte", "required": false},
    {"type": "stitching", "label": "Coutures (gros plan)", "required": true},
    {"type": "logo_detail", "label": "Logo (gros plan)", "required": true},
    {"type": "insole", "label": "Semelle intérieure", "required": true}
  ]'::jsonb),
  ('Jordan', 'jordan', 'sneakers', '[
    ...
    {"type": "box_label", "label": "Étiquette boîte", "required": false},
    {"type": "stitching", "label": "Coutures (gros plan)", "required": true},
    {"type": "jumpman_logo", "label": "Logo Jumpman (gros plan)", "required": true},
    {"type": "wings_logo", "label": "Logo Wings (si applicable)", "required": false},
    {"type": "insole", "label": "Semelle intérieure", "required": true}
  ]'::jsonb),
  ('adidas', 'adidas', 'sneakers', '[
    ...
    {"type": "sole_side", "label": "Semelle (côté)", "required": true},
    {"type": "tag_label", "label": "Étiquette intérieure", "required": true},
    {"type": "tag_size", "label": "Étiquette taille / QR code", "required": true},
    {"type": "box_label", "label": "Étiquette boîte", "required": false},
    {"type": "boost_detail", "label": "Boost / semelle (gros plan)", "required": true},
    {"type": "three_stripes", "label": "3 bandes (gros plan)", "required": true},
    {"type": "insole", "label": "Semelle intérieure", "required": true}
  ]'::jsonb),
  ('New Balance', 'new-balance', 'sneakers', '[
    ...
    {"type": "tag_label", "label": "Étiquette intérieure", "required": true},
    {"type": "tag_size", "label": "Étiquette taille", "required": true},
    {"type": "n_logo", "label": "Logo N (gros plan)", "required": true},
    {"type": "stitching", "label": "Coutures (gros plan)", "required": true},
    {"type": "insole", "label": "Semelle intérieure", "required": true}
  ]'::jsonb),
  ('Louis Vuitton', 'louis-vuitton', 'bag', '[
    {"type": "overall_front", "label": "Vue de face", "required": true},
    {"type": "overall_back", "label": "Vue arrière", "required": true},
    {"type": "overall_side", "label": "Vue de côté", "required": true},
    {"type": "overall_bottom", "label": "Vue du dessous", "required": true},
    {"type": "monogram_detail", "label": "Monogramme (gros plan)", "required": true},
    {"type": "stitching", "label": "Coutures (gros plan)", "required": true},
    {"type": "hardware", "label": "Quincaillerie / fermetures", "required": true},
    {"type": "date_code", "label": "Code date / puce RFID", "required": true},
    {"type": "interior", "label": "Intérieur du sac", "required": true},
    {"type": "zipper", "label": "Fermeture éclair (gros plan)", "required": true},
    {"type": "stamping", "label": "Marquage / estampille", "required": true}
  ]'::jsonb);
